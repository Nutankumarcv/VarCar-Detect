...
#Get video from file 
#cap = cv2.VideoCapture("/Users/newowner/Documents/Clients/Varcar-2/media/test.mp4")
...
def main(source, output:str ):

    cap = cv2.VideoCapture(source)
    cap.set(cv2.CAP_PROP_FRAME_HEIGHT,640)
    cap.set(cv2.CAP_PROP_FRAME_HEIGHT,480)
    save = cv2.VideoWriter(output, cv2.VideoWriter_fourcc(*'mp4v'),30, (1280,720))
    #Entry line 
